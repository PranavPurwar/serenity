<template>
  <div class="flex flex-col bg-gradient-to-b from-gray-800 to-[#040404] w-[100vw] min-h-[100vh] items-center">
    <AppHeader />
    <div class="rounded-3xl md:rounded-tr-[60px] md:rounded-bl-[60px] m-8 md:m-0 md:w-[60vw]"
      ...
      <div
        ...
        <div class="flex gap-4">
          <input class="rounded-3xl p-4 md:w-[30vw] border-0 outline-0" type="search" id="search" name="gsearch"
            placeholder="Search anime...">
          <img src="/svg/search.svg" alt="Search" class="h-14 w-14 p-3 bg-[#ffb7c5] rounded-2xl hover:cursor-pointer"
            @click="search" />
        </div>
